...
Alternatively, externally computed PCOs can be included using `process_PC()` for traditional morphometric data and `process_gmPC()` for 2D or 3D geometric morphometric data.
