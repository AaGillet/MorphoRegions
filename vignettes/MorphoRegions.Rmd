...
Correlations between original variables and each PCO axis are obtained using `PCOload()`. The additional 'Size' variable corresponds to the mean value of the variables.
...
Once data of each specimen have been supplied to `process_measurements()`, **the process to run the analysis is similar to running the analysis on a single specimen at a time**.
