...
relationship between a PCO axis and the vertebra or between pairs of PCO
axes.
...
- pc_y, pc_x:
  ...
  number; PC score indices for the y- and x-axes, respectively. `pc_x`
  can be `NULL`.
...
- ...:
  ...
  when `pc_x` is not `NULL`. If `scores` is supplied as an argument, it
  will replace `pc_y` if unspecified.
...
When `pc_x` is `NULL` (the default),
[`plot()`](https://rdrr.io/r/graphics/plot.default.html) will display a
scatterplot of the PCO axis identified by `pc_y` and vertebra position
using
[`ggplot2::geom_point()`](https://ggplot2.tidyverse.org/reference/geom_point.html).
This plot is similar to that generated by
[`plotsegreg()`](https://aagillet.github.io/MorphoRegions/reference/plotsegreg.md).
Otherwise, [`plot()`](https://rdrr.io/r/graphics/plot.default.html) uses
[`ggplot2::geom_text()`](https://ggplot2.tidyverse.org/reference/geom_text.html)
to identify vertebrae positions in the space corresponding to the
requested PCOs.

## See also

[`svdPCO()`](https://aagillet.github.io/MorphoRegions/reference/svdPCO.md)
for generating the PCO scores.
[`plot.regions_sim()`](https://aagillet.github.io/MorphoRegions/reference/simregions.md)
for plotting PCO scores against vertebra position for simulated PCOs.
[`plotsegreg()`](https://aagillet.github.io/MorphoRegions/reference/plotsegreg.md)
for plotting PCO scores against vertebra position after selecting
breakpoints for a segmented regression.
